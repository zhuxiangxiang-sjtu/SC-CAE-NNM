...
class StructureData:
    ...
    drag_viscous_structure: np.ndarray
...
class StructureSplit:
    ...
    drag_viscous_train: np.ndarray
    drag_viscous_valid: np.ndarray
    drag_viscous_test: np.ndarray
...
def validate_aligned_snapshot_count(flow_data, structure_data,
    ...
    available_snapshots = min(
        ...
        structure_data.drag_viscous_structure.shape[0],
    )
...
def split_structure_data(structure_data, train_snapshots=1400,
    ...
    return StructureSplit(
        ...
        drag_viscous_train=structure_data.drag_viscous_structure[:train_end, :],
        drag_viscous_valid=structure_data.drag_viscous_structure[train_end:validation_end, :],
        drag_viscous_test=structure_data.drag_viscous_structure[validation_end:test_end, :],
